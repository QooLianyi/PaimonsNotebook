...
class ContentMarginSettings(val enable:Boolean,val marginPreview:Boolean,val horizontalProgress:Int,val horizontalMargin:Int,val topProgress:Int,val topMargin:Int) {
