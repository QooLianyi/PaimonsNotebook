package com.lianyi.paimonsnotebook.common.web.uigf.client
...
import com.lianyi.paimonsnotebook.common.web.uigf.data.SaltLatestData

class UIGFClient {

    suspend fun getLatestSalt() =
        buildRequest {

        }.getAsJson<SaltLatestData>(emptyOkHttpClient)
